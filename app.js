...
class Productos{
    constructor(id,title,tipo,price,thumbnail){
        this.id= id;
        this.nombre = title;
        this.tipo = linea;
        this.precio= price;
...
function agregarAlCarrito(id) {
    ...
    if(repetido){
        ...
        div.innerHTML = `<p class="productoEnCarrito2">${productoAgregar.nombre}</p>
                        <p class="productoEnCarrito2">${productoAgregar.tipo}</p>
                        <p class="productoEnCarrito2">Precio: ${productoAgregar.precio}</p>
                        <p class="productoEnCarrito2" id="cantidad${productoAgregar.id}">cantidad: ${productoAgregar.cantidad}</p>
